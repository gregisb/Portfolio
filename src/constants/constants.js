export const projects = [
  ...
  {
    title: 'Tropix Wallet',
    description: "[Projeto Pessoal] Tropix Wallet é um sistema de gerenciamento de finanças desenvolvido em React com TypeScript. O usuário pode filtrar suas finanças de cada mês, em que o sistema irá calcular o balanço (entradas e saídas) de acordo com a data.",
    image: '/images/tropix-wallet.png',
    tags: ['React', 'TypeScript', 'styled-components'],
    source: 'https://tropix-wallet.vercel.app/',
    visit: 'https://github.com/gregisb/tropix-wallet',
    id: 2,
  },
  {
    title: 'Hamburgueria Máximo Sabor - Website',
    description: "[Projeto Freelance] Projeto em desenvolvimento de um site com design minimalista para uma hamburgueria de Belo Horizonte, MG. Utilizando as melhores práticas de CSS Grid e Flexbox, HTML e JavaScript para pequenas animações. (O cliente autorizou mostrar o andamento do projeto).",
